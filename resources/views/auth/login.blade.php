...
<body >
    ...
    <div style="display:flex;justify-content:center; align-items:center ">
     <div style="display:flex; background-color:white;margin-top:3%;border-radius:10px;">
          <div style="background-color:rgba(3, 3, 270, 0.8); width:400px;display:flex; justify-content:center; align-items:center;border-radius:10px 0px 0px 10px;">
            <div>
        ...
        <div  style=" display:inlie-block;padding:32px;">
            <div class="p0" >
                <p class="p1">Login</p>
                <p class="p2"> Please enter the neccessary <br> information to create the account</p> 
                <p class="p3"></p>
                ...
                <form method="POST" action="{{ route('login.store') }}">
                    ...
                    <p class="p4"><a href="{{ route('register.create') }}">Registrer</a></p>
                    <p class="p5"><a href="#">Forget Password</a></p>
                    </div>
                    <button> Login </button>
                </form>
            </div>
    ...
    <?php $pass = password_hash(45678910, PASSWORD_DEFAULT);
    //  echo $pass;
    ?>
</body>
</html> --}}
