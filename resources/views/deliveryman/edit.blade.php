...
<div class="card">
    <div class="card-header">
        <h1>Edit <span>Delivery Man</span></h1>
        <p>Update the delivery staff member's information</p>
        <span class="id-badge">ID #{{ $delivery_man->id }}</span>
    </div>

    <div class="card-body">
        <form method="POST" action="/delivery-man/{{ $delivery_man->id }}" id="update-form">
            @csrf
            @method('PATCH')
            ...
            <div class="field">
                ...
                <input name="name" type="text" placeholder="e.g. Jean-Paul Mbarga" value="{{ $delivery_man->user->name }}">
            ...
            <div class="form-row">
                <div class="field">
                    <label>Email</label>
                    <input name="email" type="email" placeholder="email@example.com" value="{{ $delivery_man->user->email }}">
                    @error('email') <p class="error-msg">{{ $message }}</p> @enderror
                </div>
                <div class="field">
                    <label>Mobile</label>
                    <input name="mobile" type="text" placeholder="+237 6XX XXX XXX" value="{{ $delivery_man->user->mobile }}">
            ...
            <div class="field">
                <label>Address</label>
                <input name="address" type="text" placeholder="e.g. Douala, Akwa" value="{{ $delivery_man->user->address }}">
            ...
            <div class="form-row">
                <div class="field">
                    ...
                    <input name="national_id" type="text" placeholder="###########" value="{{ $delivery_man->user->national_id }}">
            ...
            <div class="form-row">
                <div class="field">
                    ...
                    <input name="license_number" type="text" value="{{ $delivery_man->license_number }}">
                    @error('license_number') <p class="error-msg">{{ $message }}</p> @enderror
                </div>
                <div class="field">
                    <label>License Class</label>
                    <input name="license_class" type="text" value="{{ $delivery_man->license_class }}">
            ...
            <div class="form-row">
                <div class="field">
                    ...
                    <input name="vehicle_type" type="text" value="{{ $delivery_man->vehicle_type }}">
                    @error('vehicle_type') <p class="error-msg">{{ $message }}</p> @enderror
                </div>
                <div class="field">
                    <label>Plate Number</label>
                    <input name="number_plate" type="text" value="{{ $delivery_man->number_plate }}">
        ...
        <div class="btn-group-single">
            <a href="/delivery-man/{{ $delivery_man->id }}" class="btn btn-secondary">Cancel</a>
        </div>
