...
<div class="card">
    <div class="card-header">
        <h1>Create <span>Customer</span></h1>
        <p>Fill in the information below to register a new customer</p>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('customers.store') }}">
            ...
            <div class="field">
                ...
                <input name="name" type="text" placeholder="e.g. Emma Dupont">
                @error('name') <p class="error-msg">{{ $message }}</p> @enderror
            </div>

            <div class="field">
                <label>Email</label>
                <input name="email" type="email" placeholder="emma@example.com">
            ...
            <div class="field">
                <label>Address</label>
                <input name="address" type="text" placeholder="Douala, Ancien Dépôt">
            ...
            <div class="form-row">
                <div class="field">
                    <label>Mobile</label>
                    <input name="mobile" type="text" placeholder="+237 672 000 000">
