...
<body>
    ...
    <form method="POST" action="{{ route('delivery-man.store') }}">
                    ...
                    <input name="license_number" type="text" placeholder="###########"><br>
                    @error('license_number') <div>{{ $message }}</div> @enderror

                    <label>License Class</label><br>
                    <input name="license_class" type="text" placeholder="###########"><br>
                    @error('license_class') <div>{{ $message }}</div> @enderror

                    <label>Vehicle Type</label><br>
                    <input name="vehicle_type" type="text" placeholder="###########"><br>
                    @error('vehicle_type') <div>{{ $message }}</div> @enderror

                    <label>Plate Number</label><br>
                    <input name="number_plate" type="text" placeholder="###########"><br>
                    @error('number-plate') <div>{{ $message }}</div> @enderror

                    <button type="submit"> Save DeliveryMan </button>
                </form>
    </div>
</body>
