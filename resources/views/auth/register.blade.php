...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* password wrapper keeps the eye icon inside the input */
        ...
        .terms span { font-size: 0.75rem; color: var(--muted); line-height: 1.5; }
...
<div class="card">
    ...
    <div class="card-header">
        <h1>Join <span>PopDelivery</span></h1>
        <p>Create your delivery account to get started</p>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('delivery-man.store') }}">
            ...
            <div class="field">
                ...
                <input name="name" type="text" placeholder="e.g. Jean-Paul Mbarga" value="{{ old('name') }}">
            ...
            <div class="form-row">
                <div class="field">
                    <label>Email</label>
                    <input name="email" type="email" placeholder="email@example.com" value="{{ old('email') }}">
                    @error('email') <p class="error-msg">{{ $message }}</p> @enderror
                </div>
                <div class="field">
                    <label>Mobile</label>
                    <input name="mobile" type="text" placeholder="6XX XXX XXX" value="{{ old('mobile') }}">
            ...
            <div class="field">
                <label>Address</label>
                <input name="address" type="text" placeholder="e.g. Douala, Akwa" value="{{ old('address') }}">
            ...
            <div class="form-row">
                <div class="field">
                    ...
                    <input name="national_id" type="text" placeholder="###########" value="{{ old('national_id') }}">
                    @error('national_id') <p class="error-msg">{{ $message }}</p> @enderror
                </div>
                <div class="field">
                    <label>Password</label>
                    <div class="pwd-wrap">
                        <input name="password" type="password" id="password" placeholder="Min. 6 characters">
                        <button type="button" class="pwd-toggle" onclick="togglePwd()" aria-label="Toggle password">
                            <svg id="eye-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="form-row">
                <div class="field">
                    ...
                    <input name="license_number" type="text" placeholder="###########" value="{{ old('license_number') }}">
                    @error('license_number') <p class="error-msg">{{ $message }}</p> @enderror
                </div>
                <div class="field">
                    <label>License Class</label>
                    <input name="license_class" type="text" placeholder="e.g. B, C" value="{{ old('license_class') }}">
            ...
            <div class="form-row">
                <div class="field">
                    ...
                    <input name="vehicle_type" type="text" placeholder="e.g. Motorcycle" value="{{ old('vehicle_type') }}">
                    @error('vehicle_type') <p class="error-msg">{{ $message }}</p> @enderror
                </div>
                <div class="field">
                    <label>Plate Number</label>
                    <input name="number_plate" type="text" placeholder="e.g. LT 1234 A" value="{{ old('number_plate') }}">
            ...
            <div class="terms">
                ...
                <span>I accept all the <a href="#" style="color:var(--accent);font-weight:600;">terms and conditions</a> and agree to the privacy policy</span>
            </div>

            <button type="submit" class="btn btn-primary">Create Account</button>
        </form>

        <p class="login-link">Already have an account? <a href="{{ route('deliveryMan.login') }}">Sign in</a></p>
    </div>
